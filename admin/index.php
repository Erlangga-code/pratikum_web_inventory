...
// SESUDAH (sudah ditambahkan JOIN ke status_barang dan penyimpanan)
                   ...
                   <ul class="navbar-nav ms-auto">
                       ...
                       <li class="nav-item dropdown user-menu">
                           <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                               <img src="../assets/img/angga.png" class="user-image rounded-circle shadow"
                                   alt="User Image" />
                               <span class="d-none d-md-inline">Erlangga</span>
                           </a>
                           <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                               <!--begin::User Image-->
                               <li class="user-header text-bg-primary">
                                   <img src="../assets/img/angga.png" class="rounded-circle shadow"
                                       alt="User Image" />
                                   <p>
                                       Erlangga - Admin
                                       <small>Member since Mei 2026</small>
                                   </p>
                               </li>
                               <!--end::User Image-->
                               <!--begin::Menu Body-->
